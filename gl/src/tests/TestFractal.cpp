...
test::TestFractal::TestFractal() : flag(true),need_fresh_buffer_flag(false) {
...
void test::TestFractal::drawLines() {
...
void test::TestFractal::addLine(GLfloat x1, GLfloat y1, GLfloat z1, GLfloat x2, GLfloat y2, GLfloat z2){
...
void test::TestFractal::generateKochSnowflake(GLfloat ax, GLfloat ay, GLfloat az, GLfloat bx, GLfloat by, GLfloat bz, int iterations) {
    if (iterations == 0) {
...
void test::TestFractal::upadteLines(int iter) {
    m_Vertices.clear();
    while (!m_Queue.empty()) {
